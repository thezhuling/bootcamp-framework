...
public class Permit {
  ...
  @DocumentScore private double score;

  @NonNull
  @Indexed(sortable = true)
  private LocalDateTime permitTimestamp = LocalDateTime.now();

  @NonNull @Indexed private Address address;

  @NonNull @Searchable private String description;
  ...
  @NonNull @Indexed private List<Attribute> attrList;
}
