...
public interface PermitRepository extends RedisDocumentRepository<Permit, String> {
  ...
  // Result: Documents with words similar to 'haus' (tst:permit:1 and tst:permit:3). The number of %
  // indicates the allowed Levenshtein distance (later more about it). So the query would also match
  // on 'house' because 'haus' and 'house' have a distance of two.
